 ...
 * Config: en_Torrent/1337x.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"1337x","language":["en","hi"],"domains":["1337x.to","1337x.tw","1337x.gd"],"base_url":"https://www.1337x.to","search_url_format_episode":{"string_format":"/sort-search/%s+S%02dE%02d/time/desc/1/","replacement":["title","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/sort-search/%s+%04d/time/desc/1/","replacement":["title","year_int"]},"search_url_format_season_pack":{"string_format":"/sort-search/%s/time/desc/1/","replacement":["title_lower"]},"check_title_before_drill_down":true,"drill_down_title_check_attr":"|HTML|","max_more_pages":10,"more_pages_indicator":"&gt;&gt;</a></li>","next_page_path":"a[href]:contains(>>)","next_page_path_attr":"abs:href","links_on_first_page":false,"drill_down_path":"tbody tr td a[href^=/torrent]","drill_down_path_attr":"abs:href","is_torrent":true,"is_direct":false,"links_container_path":"div.page-content","link_path":"a[href^='/torrent']","link_path_attr":"abs:href","title_path":"div.box-info-heading h1","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"div.torrent-detail-page div:eq(1) div ul:eq(0) li:eq(0) a","magnet_path_attr":"href","seeders_path":"","seeders_path_attr":"","filesize_path":"div.torrent-detail-page div:eq(1) div ul:eq(1) li:eq(3)","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = '1337x';
