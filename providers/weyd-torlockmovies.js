 ...
 * Config: en_Torrent/torlockmovies.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"torlock-M","language":["hi","en"],"domains":["torlock.com","torlock.unblockit.pro","torlock.cc","torlock2.d4.re","torlock.unblockit.ch"],"base_url":"https://www.torlock.com","search_url_format_movie":{"string_format":"/all/torrents/%s-%04d.html?","replacement":["title_lower_dash","year_int"]},"check_title_before_drill_down":true,"drill_down_title_check_attr":"b","max_more_pages":10,"more_pages_indicator":"<ul class=\"pagination\">","next_page_path":"ul.pagination li.active + li a","next_page_path_attr":"href","links_on_first_page":false,"drill_down_path":"span.tv1 +a","drill_down_path_attr":"abs:href","is_torrent":true,"is_direct":false,"links_container_path":"a[href^=magnet]","link_path":"","link_path_attr":"","title_path":"/dl:contains(name) dd","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"a[href^=magnet]","magnet_path_attr":"href","seeders_path":"/dl:contains(swarm) dd b:eq(0)","seeders_path_attr":"","filesize_path":"/dl:contains(size) dd","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'torlock-M';
