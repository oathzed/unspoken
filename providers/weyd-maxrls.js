 ...
 * Config: en_DebridOnly/maxrls.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"max-rls","language":["en"],"domains":["max-rls.com"],"base_url":"https://max-rls.lalitjoshi06-9b1.workers.dev","search_url_format_episode":{"string_format":"?s=%s+%02d+%02d","replacement":["title","season_int","episode_int"]},"search_url_format_movie":{"string_format":"?s=%s+%04d","replacement":["title","year_int"]},"more_pages_indicator":"","next_page_path":"","next_page_path_attr":"","links_on_first_page":true,"drill_down_path":"","drill_down_path_attr":"","is_torrent":false,"is_direct":true,"links_container_path":"div.post p[dir=ltr]","link_path":"strong a","link_path_attr":"href","title_path":"strong:not(:has(a)):eq(0)","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"","magnet_path_attr":"","seeders_path":"","seeders_path_attr":"","filesize_path":"strong:not(:has(a)):eq(2)","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'max-rls';
