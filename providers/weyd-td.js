 ...
 * Config: en_Torrent/td.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"TD","language":["en","hi"],"domains":["torrentdownloads.pro"],"base_url":"https://www.torrentdownloads.pro","search_url_format_episode":{"string_format":"/search/?search=%s+S%02dE%02d","replacement":["title","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/search/?search=%s+%04d","replacement":["title","year_int"]},"search_url_format_season_pack":{"string_format":"/search/?search=%s","replacement":["title"]},"more_pages_indicator":"","next_page_path":"","next_page_path_attr":"","links_on_first_page":false,"drill_down_path":"div.left_shadow div.grey_bar3 a[href^=/torrent]","drill_down_path_attr":"abs:href","is_torrent":true,"is_direct":false,"links_container_path":"div.inner_container","link_path":"","link_path_attr":"","title_path":"/title","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"a[href^=magnet]","magnet_path_attr":"href","seeders_path":"","seeders_path_attr":"","filesize_path":"div.grey_bar1:has(span:contains(Total Size:))","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'TD';
