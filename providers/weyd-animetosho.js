 ...
 * Config: en_Torrent/animetosho.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"Animetosho","language":["hi","en"],"domains":["mirror.animetosho.org","animetosho.org"],"base_url":"https://animetosho.org","search_url_format_episode":{"string_format":"/search?q=%s+s%02de%02d","replacement":["title_lower","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/search?q=%s+%04d","replacement":["title_lower","year_int"]},"search_url_format_season_pack":{"string_format":"/search?q=%s","replacement":["title_lower"]},"more_pages_indicator":"","next_page_path":"","next_page_path_attr":"","links_on_first_page":true,"drill_down_path":"","drill_down_path_attr":"","is_torrent":true,"is_direct":false,"links_container_path":"div.home_list_entry","link_path":"div.link a","link_path_attr":"href","title_path":"div.link a","title_path_attr":"","details_path":"div.link a","details_path_attr":"href","magnet_path":"div.links a[href^='magnet:']","magnet_path_attr":"href","seeders_path":"div.links span[title*='Seeders']","seeders_path_attr":"","filesize_path":"div.size","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'Animetosho';
