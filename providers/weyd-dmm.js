 ...
 * Config: en_Torrent/dmm.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"DMM","language":["hi","en"],"domains":["elfhosted.com"],"base_url":"https://zilean.stremio.ru","search_url_format_episode":{"string_format":"/dmm/filtered?Query=%s&Season=%02d&Episode=%02d","replacement":["title_lower","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/dmm/filtered?Query=%s&Year=%04d","replacement":["title_lower","year_int"]},"api":{"path_title_in_array":"raw_title","path_seeders":"size","path_size":"size","path_quality":"resolution","path_hash":"info_hash"},"is_torrent":true,"is_direct":false};
  var LOG_TAG = 'DMM';
