 ...
 * Config: en_Torrent/btcq.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"BitCQ","language":["hi","en"],"domains":["bitcq.com"],"base_url":"https://sitenable.ch/o.php?b=21&f=norefer&pv=0&mobile=&u=https://bitcq.com","search_url_format_episode":{"string_format":"/search?q=%s+s%02de%02d&category%%5B%%5D=1","replacement":["title_lower","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/search?q=%s+%04d&category%%5B%%5D=1","replacement":["title_lower","year_int"]},"search_url_format_season_pack":{"string_format":"/search?q=%s&category%%5B%%5D=1","replacement":["title_lower"]},"more_pages_indicator":"li:has(a[href*='&raquo;'])","next_page_path":"li:has(a[href*='&rsaquo;'])","next_page_path_attr":"href","max_more_pages":5,"links_on_first_page":true,"drill_down_path":"","drill_down_path_attr":"","is_torrent":true,"is_direct":false,"links_container_path":"table tbody tr","link_path":"","link_path_attr":"","title_path":"td:eq(1)","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"td:eq(0) a[href^=magnet]","magnet_path_attr":"href","seeders_path":"td:eq(4)","seeders_path_attr":"","filesize_path":"td:eq(3)","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'BitCQ';
