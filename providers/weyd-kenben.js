 ...
 * Config: en_Torrent/kenben.json
 */
(function (global) {
  'use strict';

  var WEYD_SOURCE_CONFIG = {"name":"KnaBen","language":["hi","en"],"domains":["knaben.eu"],"base_url":"https://knaben.org","search_url_format_episode":{"string_format":"/search/?cat=All&q=%s+s%02de%02d&fast=0","replacement":["title_lower","season_int","episode_int"]},"search_url_format_movie":{"string_format":"/search/?cat=All&q=%s+%04d&fast=0","replacement":["title_lower","year_int"]},"more_pages_indicator":"","next_page_path":"","next_page_path_attr":"","links_on_first_page":true,"drill_down_path":"","drill_down_path_attr":"","is_torrent":true,"is_direct":false,"links_container_path":"tbody tr","link_path":"","link_path_attr":"","title_path":"td:eq(1) a[title]","title_path_attr":"","details_path":"|title_path|","details_path_attr":"","magnet_path":"td:eq(1) a","magnet_path_attr":"href","seeders_path":"td:eq(4)","seeders_path_attr":"","filesize_path":"td:eq(2)","filesize_path_attr":"","quality_path":"|title_path|","quality_path_attr":"","info_path":"|title_path|","info_path_attr":""};
  var LOG_TAG = 'KnaBen';
